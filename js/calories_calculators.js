...
function calc_BMI() {
    ...
    0 == b ? ($("#bmi_value").text(""), $("#bmi_level").text(" "), $("#indicator").text("Please complete the form!")) : (a = 1E4 * a / (b * b), $("#bmi_value").text(a.toFixed(2)), 30 < a ? ($("#bmi_level").text("Obese"), $("#indicator")) : 25 < a ? ($("#bmi_level").text("Overweight"), $("#indicator")) : 18.5 < a ? ($("#bmi_level").text("Normal"), $("#indicator")) : 16.5 < a ? ($("#bmi_level").text("Underweight"), $("#indicator")) : 0 < a ? ($("#bmi_level").text("Serverely Underweight"), $("#indicator")) : ($("#bmi_value").text(""), $("#bmi_level").text(""), $("#indicator").text("Please complete the form!")))
}
